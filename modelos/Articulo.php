...
Class Articulo
{
  ...
  //Implementamos metodo para insertar registro
    ...
    {
      /*$sql="SELECT a.idarticulo, di.idarticulo,a.idcategoria,c.nombre as idcategoria,a.descripcion,a.unidad_medida,a.nombre,a.stock,di.fecha_vencimiento as fecha_venci 
      FROM articulo a
    ...
    {
      $sql="SELECT a.idarticulo,a.idcategoria,di.idarticulo,c.nombre as categoria,a.codigo,a.nombre,a.stock,a.descripcion,a.imagen,a.unidad_medida,a.descripcion_otros,a.condicion,DATE_FORMAT(di.fecha_vencimiento, '%d/%m/%Y') as fecha_vencimiento   
      FROM articulo a 
      left join detalle_ingreso di on a.idarticulo=di.idarticulo
      inner join categoria c on a.idcategoria=c.idcategoria ORDER by a.idarticulo desc";
      return ejecutarConsulta($sql);
    ...
    {
      $sql="SELECT a.idarticulo,a.idcategoria,c.nombre as categoria,a.codigo,a.nombre,a.stock,a.descripcion,a.imagen,a.condicion,a.afectacion,a.fecha_vencimiento  FROM articulo a inner join categoria c on a.idcategoria=c.idcategoria where a.condicion='1'";
      return ejecutarConsulta($sql);
