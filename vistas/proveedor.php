               ...
               <div class="col-md-12">
                   <div class="box">
                     <div class="box-header with-border">
                           <h1 class="box-title">Proveedor&nbsp;&nbsp;<button id="agregarProveedor" class="btn btn-success"
                             onclick="mostrarform(true)">
                             <i class="fa fa-plus-circle"></i> &nbsp;Agregar</button></h1>
                             <button class="btn btn-default" data-toggle="modal" id="consultaSunat" data-target="#modalConsultarSunat">Consultar a SUNAT <i class="fa fa-question"></i></button>
                     ...
                     <div class="panel-body" style="height: 400px;" id="formularioregistros">
                      ...
                      <form name="formulario" method="POST" id="formulario">
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          ...
                          <input type="text" class="form-control" name="nombre" id="nombre" maxlength="100" placeholder="Razon Social" required>
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                          <label>Numero </label>
                          <input type="text" class="form-control" name="num_documento" id="num_documento" maxlength="20" placeholder="Numero">
                        </div>
