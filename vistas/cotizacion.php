              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Proforma en Formato A4&nbsp;&nbsp; <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> &nbsp;&nbsp;Agregar</button></h1>
                    ...
                    <div class="panel-body" style="" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            ...
                            <input type="hidden" class="form-control" name="serie" id="serie" maxlength="4" placeholder="Serie">
                        
                            <input type="hidden" class="form-control" name="correlativo" id="correlativo" >
                          
                            <input type="hidden" class="form-control" name="impuesto" id="impuesto" value="18.0">
