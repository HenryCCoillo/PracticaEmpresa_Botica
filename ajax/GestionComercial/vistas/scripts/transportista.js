       ...
       $.ajax(
        ...
        success : function(datos){
            ...
            if (datos == 1) { // -- Registra
              ...
              tabla.ajax.reload();
              mostrarform(false);
            } else if (datos == 2) { // -- Ya se encuentra registrado
              // --
              swal({
                title: "ADVERTENCIA",
                text: "Transportista existente,vuelva a intentarlo.!",
                type:"warning",
                confirmButtonText: "Cerrar",
                closeOnConfirm: true
              })
              ...
              swal({
                title: "ERROR",
                text: "Ocurrio un problema al guardar, comuniquese con sistemas.",
                type:"error",
                confirmButtonText: "Cerrar",
                closeOnConfirm: true
              })
