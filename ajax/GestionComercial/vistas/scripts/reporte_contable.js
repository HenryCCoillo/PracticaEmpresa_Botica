...
function init(){
	...
	listar();
	$.post("../ajax/venta_contable.php?op=selectUsuario",function(r){
		$("#idusuario").html(r);
              $('#idusuario').selectpicker('refresh');

	});

	$.post("../ajax/venta_contable.php?op=selectTipoPago",function(r){
		$('#codigotipo_pago').html(r);
		$('#codigotipo_pago').selectpicker('refresh');

});
	$.post("../ajax/venta_contable.php?op=selectTipoComprobanteReporte",function(r){
...
function listar(){
	...
	tabla=$("#tbllistado").dataTable(
		{
			 "aProcessing": true, //Activamos el procesamiento de datatables
      		...
      		"ajax":{
      			url:"../ajax/consultas_contable.php?op=ventasFechaUsuario",
	...
	$.post("../ajax/consultas_contable.php?op=sumVentasFechaUsuario",{fecha_inicio:fecha_inicio,fecha_fin:fecha_fin,hora_inicio:hora_inicio,hora_fin:hora_fin,idusuario:idusuario,codigotipo_pago:codigotipo_pago,codigotipo_comprobante:codigotipo_comprobante},function(data,status){
