          ...
          <ul class="sidebar-menu">
            ...
            if($_SESSION['ventas']==1)
            {
              echo '<li class="treeview">
                  ...
                  <ul class="treeview-menu">
                  <li><a href="venta.php"><i class="fa fa-circle-o"></i> Facturación por Venta</a></li>
                  <li><a href="ticket.php"><i class="fa fa-circle-o"></i> Ticket</a></li>
              ...
              <!--<li><a href="guia.php"><i class="fa fa-circle-o"></i> Guia de Remision</a></li>   
                  <li><a href="transportista.php"><i class="fa fa-circle-o"></i> Transportista</a></li>
              ...
              echo '<li class="treeview">
                  ...
                  <ul class="treeview-menu">
                   <li><a href="factura.php"><i class="fa fa-circle-o"></i> Facturación por Servicio</a></li>
                    ...
                    <li><a href="desarrollo.php"><i class="fa fa-circle-o"></i> Desarrollo</a></li> 
