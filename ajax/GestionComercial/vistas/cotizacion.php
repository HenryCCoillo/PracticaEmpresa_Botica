                        ...
                        <form name="formulario" id="formulario" method="POST">
                         ...
                         <!--  <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                           ...
                           <div class="form-group col-lg-5 col-md-5 col-sm-5 col-xs-12">
                            ...
                            <input type="hidden" class="form-control" name="correlativo" id="correlativo" maxlength="8" >
                          ...
                          <div class="form-group col-lg-5 col-md-5 col-sm-5 col-xs-12">
                           <label>Validez de la Oferta</label>                           
                            <input type="number" class="form-control" name="validez" id="validez" placeholder="Validez de la oferta" required="" maxlength="50">
                           </div> 
