               ...
               <div class="col-md-12">
                   <div class="box">
                     <div class="box-header with-border">
                           <h1 class="box-title">Registro de Personas&nbsp;&nbsp;&nbsp;&nbsp;<button id="agregarSucursal" class="btn btn-success"
                     ...
                     <div class="panel-body" style="height: 400px;" id="formularioregistros">
                      ...
                      <form name="formulario" method="POST" id="formulario">
                          ...
                          <input type="hidden" name="tipo_persona" id="tipo_persona" value="Sucursal">
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input type="text" class="form-control" name="num_documento" id="num_documento" maxlength="20" placeholder="Numero" required value="-">
                        </div>
...
require 'footer.php';
    ...
    <script type="text/javascript" src="scripts/sucursal.js">
    </script>
    <?php
    }
    ob_end_flush();
