...
<div class="cliente">
	...
	<table cellspacing="0" cellpadding="0" border="0.5"  class="pagos" >
			<tr>
				<td style="width:30%"><b>Fecha de Emisión</b><br><?php echo strftime("%d de %B del %Y", strtotime($fecha)); ?></td>				
				<td style="width:30%" ><b>Moneda</b><br><?php echo $moneda; ?> </td>
				<!-- <td style="width:25%"><b>Orden de Compra</b><br><?php echo $oeden_compra; ?> </td> -->
				<td style="width:30%" ><b>Asesor Comercial</b><br><?php echo $usuario; ?></td>			
			</tr>
			<tr>
				<td style="width:30%"><b>Fecha de Vencimiento</b><br><?php echo strftime("%d de %B del %Y", strtotime($fecha_ven)); ?></td>
				<td style="width:30%" ><b>Condición de Pago</b><br><?php echo $codigotipo_pago; ?></td>
				<!-- <td style="width:25%"><b>Nº de Guia</b><br><?php echo $num_guia; ?> </td> -->
				<td style="width:30%"><b>Control Interno</b><br><!-- <?php echo $num_guia; ?>--> </td>	
			</tr>
	</table> 
</div>	
<!-- Fin Cliente-->
