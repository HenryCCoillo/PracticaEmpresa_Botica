...
?>
	<p style="title; text-align:center"><b> REPORTE DE INGRESO</b></p>
<div class="cliente">
	<table style="width: 100%;">
		<tr style="">
			<td><b>Registro</b> </td>
...
<div  class="productos" style="width: 100%">
	<table style="border: solid 0.3px #000; ">
		<tr class="cabecera" style="width: 100%; text-align: center">		            
		    <th style="width: 60%; text-align:center">DESCRIPCION DE LOS PRODCUTOS</th>
		    <th style="width: 5%; text-align:center">V°B°</th>
	...
	<table style="BORDER CELLPADDING=10 CELLSPACING=0">
    	...
    	<tr class="productos" style="width: 100%; text-align: center; ">
			<td style="width: 60%; text-align:left; border: solid 0.3px #000;"><?php echo $reg_det->nombre; ?></td>
			<th style="width: 5%; text-align:center;  border: solid 0.3px #000;"></th>
