	...
	<table  class="cuadro-cliente">
	   	...
	   	<tr>
	   		...
	   		<td style="width: 90%">: <?php echo strftime("%d de %B del %Y", strtotime($fecha)); ?>
	   		 ...
	   		 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Tiempo de entrega</b> : <?php echo $tiempo_entrega;?> días
				...
				<table  class="articulo" border="0.4" cellpadding="0" cellspacing="1" bordercolor="black" style="border-collapse:collapse;">
						...
						<tr>					
							<td style="width:74.9%; height:6px; padding-top: 6px; padding-left: 5px;  text-align: justify;">
								<?php echo $regd->articulo.' '.$regd->serieCotizacion; ?></td>
							...
							<td style="width:10%;height:6px; padding-top: 6px; text-align: right;"><?php $subTotal =  $regd->precio_venta*$regd->cantidad-$regd->descuento; echo number_format($subTotal,2);?>&nbsp;&nbsp;&nbsp;&nbsp;</td>
					</tr>
	        		 <?php }?>	
				</table>
			</td>
...
<div class="total">
        ...
        <tr>
		      ...
		      <td style="text-align: right; width:20%"><?php echo number_format($sumigv,2,'.',','); ?>&nbsp;&nbsp;&nbsp;</td>
        </tr>
        <tr >
