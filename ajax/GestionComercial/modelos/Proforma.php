...
Class Proforma
{
  ...
  public function insertar($idusuario,$idcliente,$correlativo,$tipo_proforma,$igv_total,$referencia,$total_venta,$fecha_hora,$descripcion,$cantidad,$precio,$validez){

    $sql="INSERT INTO proforma (idusuario,idcliente,correlativo,tipo_proforma,igv_total,referencia,total_venta,fecha_hora,estado,validez) VALUES ('$idusuario','$idcliente','$correlativo','$tipo_proforma','$igv_total','$referencia','$total_venta','$fecha_hora','AceptadoP','$validez')";
    // return ejecutarConsulta($sql);s
