...
Class Cotizacion
{
	...
	public function insertar($idcliente,$idusuario,$codigotipo_comprobante,$serie,$correlativo,$fecha_hora,$impuesto,$op_gravadas,$op_inafectas,$op_exoneradas,$op_gratuitas,$isc,$total_venta,$idmoneda,$idarticulo,$cantidad,$precio_venta,$descuento,$serieCotizacion,$validez,$tiempo_entrega){
		...
		$sql="INSERT INTO venta (idcliente,idusuario,codigotipo_comprobante,serie,correlativo,fecha_hora,impuesto,op_gravadas,op_inafectas,op_exoneradas,op_gratuitas,isc,total_venta,estado,idmoneda,idmotivo_doc,validez,tiempo_entrega) VALUES ('$idcliente','$idusuario','$codigotipo_comprobante','$serie','$correlativo','$fecha_hora','$impuesto','$op_gravadas','$op_inafectas','$op_exoneradas','$op_gratuitas','$isc','$total_venta','Cotizado','$idmoneda',null,'$validez','$tiempo_entrega')";
