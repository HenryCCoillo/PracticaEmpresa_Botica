...
Class Ingreso
{
  ...
  //Implementamos metodo para insertar registro
    public function insertar($idproveedor,$idusuario,$tipo_comprobante,$serie_comprobante,$num_comprobante,$fecha_hora,$impuesto,$total_compra,$idarticulo,$cantidad,$precio_compra,$precio_venta,$credito,$cuota,$valorcuota,$tipocredito,$fechainicio,$diapago,$fechasElegidas)
    {
