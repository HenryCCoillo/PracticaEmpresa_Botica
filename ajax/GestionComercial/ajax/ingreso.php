    ...
    case 'guardaryeditar':
      if(empty($idingreso))
      {
        ...
        if(isset($_POST["fechasElegidas"])){
            $rspta=$ingreso->insertar($idproveedor,$idusuario,$tipo_comprobante,$serie_comprobante,$num_comprobante,$fecha_hora,$impuesto,$total_compra,$_POST["idarticulo"],$_POST["cantidad"],$_POST["precio_compra"],$_POST["precio_venta"],$credito,$cuota,$valorcuota,$tipocredito,$fechainicio,$diapago,$_POST["fechasElegidas"]);

        }else{
            $fechasElegidas="";
            $rspta=$ingreso->insertar($idproveedor,$idusuario,$tipo_comprobante,$serie_comprobante,$num_comprobante,$fecha_hora,$impuesto,$total_compra,$_POST["idarticulo"],$_POST["cantidad"],$_POST["precio_compra"],$_POST["precio_venta"],$credito,$cuota,$valorcuota,$tipocredito,$fechainicio,$diapago,$fechasElegidas);
