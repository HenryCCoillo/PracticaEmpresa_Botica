...
switch ($_GET["op"]){
	...
	case 'listar':
		...
		while ($reg=$rspta->fetch_object()) {
			if($reg->idmotivo_doc=='1' || $reg->idmotivo_doc=='2' || $reg->idmotivo_doc=='3' || $reg->idmotivo_doc=='4' || $reg->idmotivo_doc=='5'|| $reg->idmotivo_doc=='6' || $reg->idmotivo_doc=='7'|| $reg->idmotivo_doc=='8'){
